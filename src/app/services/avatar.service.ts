  ...
  async loadWorld(firestoreEntity: AvatarStoredDataType): Promise<WorldAvatar> {
    if (!firestoreEntity.jsonModel) {
      ...
      const read = await firstValueFrom(
        this.http.get('/assets/scenarios/base.json', {
          responseType: 'json',
        }),
      );
      return read as any;
                      ...
                      options: [
                        {
                          ...
                          label: 'Un corazón',
                          answer:
                            'La próxima vez seguro lo recordarás mejor. Los humanos tenemos un solo corazón, pero los pulpos tienen 3. Dos bombean sangre a las branquias y uno a todo el cuerpo.',
                        },
                        {
                          points: 1,
                          label: 'Tres corazónes',
                          answer:
                            '¡Sí, tres! Dos bombean sangre a las branquias y uno a todo el cuerpo.',
                        },
                      ],
                    },
                    {
                      ...
                      options: [
                        {
                          ...
                          label: 'Rosada',
                          answer:
                            'Casi aciertas. Es morada para protegerse del sol mientras come hojas todo el día.',
                        },
                        {
                          points: 1,
                          label: 'Morada/azul',
                          answer:
                            'Excelente, Es morada para protegerse del sol mientras come hojas todo el día.',
                        },
                      ],
                    },
                    {
                      ...
                      options: [
                        {
                          ...
                          label: 'El caballo',
                          answer:
                            'Muy bien, Los caballos pueden dormir parados para escapar rápido del peligro.',
                        },
                        {
                          points: 0,
                          label: 'El conejo',
                          answer:
                            'Estabas cerca, Los caballos pueden dormir parados para escapar rápido del peligro.',
                        },
                      ],
                    },
                    {
                      ...
                      options: [
                        {
                          ...
                          label: 'El camaleón',
                          answer:
                            'Acertaste! El camaleón cambia de color para esconderse y también según cómo se siente.',
                        },
                        {
                          points: 0,
                          label: 'El elefante',
                          answer:
                            'Puedes volver a intentarlo más tarde. El camaleón cambia de color para esconderse y también según cómo se siente.',
                        },
                      ],
                    },
                    {
                      label:
                        '¿Qué animal es tan fuerte que puede cargar cosas mucho más pesadas que su propio cuerpo?',
                      options: [
                        {
                          points: 0,
                          label: 'La tortuga',
                          answer:
                            'Luego tendrás otra oportunidad, ¡Una hormiga puede levantar hasta 50 veces su peso! Sería como si tú cargaras un carro.',
                        },
                        {
                          points: 1,
                          label: 'La hormiga',
                          answer:
                            'Genial! ¡Una hormiga puede levantar hasta 50 veces su peso! Sería como si tú cargaras un carro.',
                        },
                      ],
                    },
                    /*
